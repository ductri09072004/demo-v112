...
def metrics():
    ...
    metrics_text = """# HELP demo-v112_requests_total Total number of requests
# TYPE demo-v112_requests_total counter
demo-v112_requests_total {request_count}

# HELP demo-v112_response_time_seconds Average response time
# TYPE demo-v112_response_time_seconds gauge
demo-v112_response_time_seconds {avg_response_time:.3f}

# HELP demo-v112_active_connections Current active connections
# TYPE demo-v112_active_connections gauge
demo-v112_active_connections {active_connections}

# HELP demo-v112_memory_usage_bytes Memory usage in bytes
# TYPE demo-v112_memory_usage_bytes gauge
demo-v112_memory_usage_bytes {memory_usage}
""".format(
        SERVICE_NAME="demo-v112",
